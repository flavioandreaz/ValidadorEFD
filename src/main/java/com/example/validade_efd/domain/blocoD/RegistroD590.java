...
public class RegistroD590 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"D590\"", tipo = TipoCampo.C, tamanho = 4, obrigatorioEntrada = true, obrigatorioSaida = true)
    private String reg;
    ...
    @Campo(numero = 8, nome = "VL_BC_ICMS_UF", descricao = "Parcela correspondente ao valor da base de cálculo do ICMS de outras UFs, referente à combinação de CST_ICMS, CFOP e alíquota do ICMS", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = true, obrigatorioSaida = true)
    private double vlBcIcmsUf;

    @Campo(numero = 9, nome = "VL_ICMS_UF", descricao = "Parcela correspondente ao valor do ICMS de outras UFs, referente à combinação de CST_ICMS, CFOP, e alíquota do ICMS", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = true, obrigatorioSaida = true)
    ...
    @Campo(numero = 11, nome = "COD_OBS", descricao = "Código da observação (campo 02 do Registro 0460)", tipo = TipoCampo.C, tamanho = 6, obrigatorioEntrada = false, obrigatorioSaida = true)
