...
public class RegistroD370 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"D370\"", tipo = TipoCampo.C, tamanho = 4, obrigatorioEntrada = false, obrigatorioSaida = true)
    private String reg;
    ...
    @Campo(numero = 4, nome = "QTD_BILH", descricao = "Quantidade de bilhetes emitidos", tipo = TipoCampo.N, obrigatorioEntrada = true, obrigatorioSaida = true)
    private int qtdBilhe;

    @Campo(numero = 5, nome = "VL_BC_ICMS", descricao = "Valor total da base de cálculo do ICMS", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = false, obrigatorioSaida = true)
    private double vlBcIcms;

    @Campo(numero = 6, nome = "VL_ICMS", descricao = "Valor total do ICMS", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = false, obrigatorioSaida = true)
