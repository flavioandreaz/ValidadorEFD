...
public class RegistroD420 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"D420\"", tipo = TipoCampo.C, tamanho = 4, obrigatorioEntrada = false, obrigatorioSaida = true)
    private String reg;
    ...
    @Campo(numero = 4, nome = "VL_BC_ICMS", descricao = "Valor total da base de cálculo do ICMS", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = true, obrigatorioSaida = true)
    private double vlBcIcms;

    @Campo(numero = 5, nome = "VL_ICMS", descricao = "Valor total do ICMS", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = true, obrigatorioSaida = true)
