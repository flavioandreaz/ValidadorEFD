...
public class RegistroK301 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"K301\"", tipo = TipoCampo.C, tamanho = 4, obrigatorio = true)
    private String reg;
    ...
    @Campo(numero = 3, nome = "QTD", descricao = "Quantidade produzida", tipo = TipoCampo.N, tamanho = 3, obrigatorio = true)
    private double qtd;
}