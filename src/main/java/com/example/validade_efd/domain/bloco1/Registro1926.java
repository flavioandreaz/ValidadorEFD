...
public class Registro1926 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"1926\"", tipo = TipoCampo.C, tamanho = 4, obrigatorio = true)
    private String reg;
    ...
    @Campo(numero = 3, nome = "VL_OR", descricao = "Valor da obrigação a recolher", tipo = TipoCampo.N, tamanho = 2, obrigatorio = true)
    private double vlOr;
    ...
    @Campo(numero = 5, nome = "COD_REC", descricao = "Código de receita referente à obrigação, próprio da unidade da federação, conforme legislação estadual", tipo = TipoCampo.C, obrigatorio = true)
