...
@EqualsAndHashCode
@Builder
@MetadadosRegistro(nivelHierarquico = 6, ocorrencia = OcorrenciaRegistro.UM_PARA_N)
public class Registro1923 {

    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"1923\"", tipo = TipoCampo.C, tamanho = 4, obrigatorio = true)
    private String reg;

    @Campo(numero = 2, nome = "COD_PART", descricao = "Código do participante (campo 02 do Registro 0150): - do emitente do documento ou do remetente das mercadorias, no caso de entradas; - do adquirente, no caso de saídas", tipo = TipoCampo.C, tamanho = 60, obrigatorio = true)
    ...
    @Campo(numero = 10, nome = "CHV_DOCe", descricao = "Chave do Documento Eletrônico", tipo = TipoCampo.N, tamanho = 44, obrigatorio = false)
