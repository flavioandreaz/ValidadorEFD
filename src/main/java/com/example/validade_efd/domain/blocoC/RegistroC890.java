...
public class RegistroC890 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"C890\"", tipo = TipoCampo.C, tamanho = 4, obrigatorioEntrada = false, obrigatorioSaida = true)
    private String reg;
    ...
    @Campo(numero = 5, nome = "VL_OPR", descricao = "Valor total do CF-e na combinação de CST_ICMS, CFOP e alíquota do ICMS, correspondente ao somatório do valor líquido dos itens", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = true, obrigatorioSaida = true)
    ...
    @Campo(numero = 8, nome = "COD_OBS", descricao = "Código da observação do lançamento fiscal (campo 02 do registro 0460)", tipo = TipoCampo.C, tamanho = 6, obrigatorioEntrada = false, obrigatorioSaida = true)
