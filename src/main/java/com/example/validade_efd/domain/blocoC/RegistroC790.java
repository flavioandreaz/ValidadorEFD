...
public class RegistroC790 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"C790\"", tipo = TipoCampo.C, tamanho = 4, obrigatorioEntrada = false, obrigatorioSaida = true)
    private String reg;
    ...
    @Campo(numero = 8, nome = "VL_BC_ICMS_ST", descricao = "Valor da base de cálculo do ICMS substituição tributária", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = false, obrigatorioSaida = true)
    private double vlBcIcmsSt;

    @Campo(numero = 9, nome = "VL_ICMS_ST", descricao = "Valor do ICMS retido por substituição tributária", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = false, obrigatorioSaida = true)
