...
public class RegistroC390 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"C390\"", tipo = TipoCampo.C, tamanho = 4, obrigatorioEntrada = false, obrigatorioSaida = true)
    private String reg;
    ...
    @Campo(numero = 6, nome = "VL_BC_ICMS", descricao = "Valor acumulado da base de cálculo do ICMS, referente à combinação de CST_ICMS, CFOP, e alíquota do ICMS.", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = false, obrigatorioSaida = true)
    private double vlBcIcms;

    @Campo(numero = 7, nome = "VL_ICMS", descricao = "Valor acumulado do ICMS, referente à combinação de CST_ICMS, CFOP e alíquota do ICMS.", tipo = TipoCampo.N, tamanho = 2, obrigatorioEntrada = false, obrigatorioSaida = true)
