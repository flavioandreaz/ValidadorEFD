...
public class Registro0001 {
    ...
    @Campo(numero = 2, nome = "IND_MOV", descricao = "Indicador de movimento: 0- Bloco com dados informados; 1- Bloco sem dados informados.", tipo = TipoCampo.N, tamanho = 1, obrigatorio = true)
