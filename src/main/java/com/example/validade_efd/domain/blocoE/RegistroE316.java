...
public class RegistroE316 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"E316\"", tipo = TipoCampo.C, tamanho = 4, obrigatorio = true)
    private String reg;

    @Campo(numero = 2, nome = "COD_OR", descricao = "Código da obrigação recolhida ou a recolher, conforme a Tabela 5.4", tipo = TipoCampo.C, tamanho = 3, obrigatorio = true)
    private String codOr;

    @Campo(numero = 3, nome = "VL_OR", descricao = "Valor da obrigação recolhida ou a recolher", tipo = TipoCampo.N, tamanho = 2, obrigatorio = true)
    private double vlOr;
    ...
    @Campo(numero = 5, nome = "COD_REC", descricao = "Código de receita referente à obrigação, próprio da unidade da federação da origem/destino, conforme legislação estadual", tipo = TipoCampo.C, obrigatorio = true)
    ...
    @Campo(numero = 9, nome = "TXT_COMPL", descricao = "Descrição complementar das obrigações recolhidas ou a recolher", tipo = TipoCampo.C, obrigatorio = false)
