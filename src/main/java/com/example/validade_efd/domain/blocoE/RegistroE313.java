...
public class RegistroE313 {
    ...
    @Campo(numero = 1, nome = "REG", descricao = "Texto fixo contendo \"E313\"", tipo = TipoCampo.C, tamanho = 4, obrigatorio = true)
    private String reg;

    @Campo(numero = 2, nome = "COD_PART", descricao = "Código do participante (campo 02 do Registro 0150)", tipo = TipoCampo.C, tamanho = 60, obrigatorio = true)
    ...
    @Campo(numero = 7, nome = "CHV_DOCe", descricao = "Chave do Documento Eletrônico", tipo = TipoCampo.N, tamanho = 44, obrigatorio = false)
    ...
    @Campo(numero = 9, nome = "COD_ITEM", descricao = "Código do item (campo 02 do Registro 0200)", tipo = TipoCampo.C, tamanho = 60, obrigatorio = false)
    private String codItem;

    @Campo(numero = 10, nome = "VL_AJ_ITEM", descricao = "Valor do ajuste para a operação/item", tipo = TipoCampo.N, tamanho = 2, obrigatorio = true)
