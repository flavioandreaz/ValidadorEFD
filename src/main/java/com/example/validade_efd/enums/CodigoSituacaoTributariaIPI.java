...
public enum CodigoSituacaoTributariaIPI {
    ...
    CodigoSituacaoTributariaIPI(String codigo, String descricao) {
        this.codigo = codigo;
    ...
    public static CodigoSituacaoTributariaIPI fromCodigo(String codigo) {
        for (CodigoSituacaoTributariaIPI tipo : CodigoSituacaoTributariaIPI.values()) {
